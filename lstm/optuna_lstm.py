...
class LSTM(nn.Module):
    def __init__(self, trial, num_features, hidden_units, num_layers, dropout, num_features_pred, d_linear, device):
        super().__init__()
        ...
        self.lstm = nn.LSTM(input_size=num_features,
                            ...
                            dropout = dropout)
        self.fc1 = nn.Linear(in_features=hidden_units, out_features=d_linear)
